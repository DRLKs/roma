...
CPP_SOURCE = ROOT / "runners" / "cpp" / "rastrigin_pagmo_benchmark.cpp"
CACHE_DIR = ROOT / ".cache" / "pagmo_cpp"
BINARY_PATH = CACHE_DIR / "rastrigin_pagmo_benchmark"
...
def benchmark_args(seed):
    return [
        ...
        BUDGET["type"],
        str(BUDGET["value"]),
        str(PAGMO_CONFIG["start_range"]),
        str(PAGMO_CONFIG["stop_range"]),
        str(PAGMO_CONFIG["reduction_coeff"]),
        str(seed),
    ]
